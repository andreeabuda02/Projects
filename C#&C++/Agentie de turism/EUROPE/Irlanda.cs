...
namespace Agentie_de_turism
{
    public partial class Irlanda : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X, buttonNord.Location.Y);
            buttonSud.Location = new Point(buttonSud.Location.X, buttonSud.Location.Y - 80);
            buttonVest.Location = new Point(buttonVest.Location.X + 300, buttonVest.Location.Y);
            buttonEst.Location = new Point(buttonEst.Location.X - 50, buttonEst.Location.Y);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X + 80, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y);
        ...
        public Irlanda(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Irlanda_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cork__THE_METROPOLE_HOTEL;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 7)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Dublin__HOTEL_BUSWELLS;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Galway__HOTEL_GALMONT;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kilkenny__HOTEL_KILKENNY;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Limerick__HOTEL_LIMERICK_CITY;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Londonderry__HOTEL_DERRY;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Waterford__HOTEL_TREACYS;
            }
            else
            {
                hotel = 1;
