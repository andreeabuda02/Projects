...
namespace Agentie_de_turism
{
    public partial class Malta : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X, buttonNord.Location.Y + 150);
        ...
        public Malta(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Malta_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Attard__HOTEL_CORINTHIA_PALACE;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 4)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.La_Saint_Julian_s___HOTEL_THE_ST__GEORGE_S_PARK;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Mellieha___HOTEL_MELLIEHA_BAY;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Valletta___HOTEL_GRAND_EXCELSIOR;
            }
            else
            {
                hotel = 1;
