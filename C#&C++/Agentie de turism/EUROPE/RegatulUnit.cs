...
{
    public partial class RegatulUnit : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X - 100, buttonNord.Location.Y + 110);
            buttonSud.Location = new Point(buttonSud.Location.X + 130, buttonSud.Location.Y - 20);
            buttonVest.Location = new Point(buttonVest.Location.X + 250, buttonVest.Location.Y + 80);
            buttonEst.Location = new Point(buttonEst.Location.X - 200, buttonEst.Location.Y + 200);
        ...
        public RegatulUnit(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void RegatulUnit_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Aberdeen__THE_STATION_HOTEL;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 13)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Birmingham__HOTEL_BRITANNIA_BIRMINGHAM;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cambridge__HOTEL_IBIS_CAMBRIDGE;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Dumfries__HOTEL_CAIRNDALE;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Edinburgh__HOTEL_MARRIOTT;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Glasgow__HOTEL_INDIGO_GLASGOW;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Inverness__HOTEL_THE_ROYAL_HIGHLAND;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Liverpool__HOTEL_DOLBY;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Londra__HOTEL_DUBLETREE_BY_HILTON;
                                                else
                                                    if (hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Manchester__HOTEL_PARK_INN;
                                                    else
                                                        if (hotel == 11)
                                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Norwich__HOTEL_EXPRESS;
                                                        else
                                                            if (hotel == 12)
                                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sheffield__HOTEL_HAMPTON_BY_HILTON;
                                                            else
                                                                if(hotel == 13)
                                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Wick__HOTEL_NETHERCLIFFE;
            }
            else
            {
                hotel = 1;
