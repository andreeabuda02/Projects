...
{
    public partial class Danemarca : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonSud.Location = new Point(buttonSud.Location.X, buttonSud.Location.Y - 125);
            buttonVest.Location = new Point(buttonVest.Location.X + 70, buttonVest.Location.Y - 50);
            buttonEst.Location = new Point(buttonEst.Location.X - 180, buttonEst.Location.Y + 170);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X - 250, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y);
        ...
        public Danemarca(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Danemarca_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Aalborg__HOTEL_FIRST;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Aarhus__HOTEL_ROYAL;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Copenhaga__HOTEL_GRAND_HOTEL;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Esbjerg__HOTEL_ANSGAR;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Odense__HOTEL_MILLING_PLAZA;
            }
            else
            {
                hotel = 1;
