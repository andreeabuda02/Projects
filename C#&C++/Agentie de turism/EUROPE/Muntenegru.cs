...
{
    public partial class Muntenegru : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonEst.Location = new Point(buttonEst.Location.X - 180, buttonEst.Location.Y - 150);
        ...
        public Muntenegru(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Muntenegru_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Berane__HOTEL_BERANE;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 9)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Budva__HOTEL_FALKENSTEINER;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kotor__HOTEL_SARA;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Nikšić__HOTEL_ONOGOST;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Pljevjla__HOTEL_PLJEVJLA;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Podgorica__HOTEL_PODGORICA;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tivat__HOTEL_REGENT_PORTO;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Ulcinj__HOTEL_AMBIENTE;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Žabljak__HOTEL_ŽABLJAK;
            }
            else
            {
                hotel = 1;
