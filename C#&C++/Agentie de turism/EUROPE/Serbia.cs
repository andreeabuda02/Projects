...
{
    public partial class Serbia : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X - 300, buttonNord.Location.Y - 50);
            buttonSud.Location = new Point(buttonSud.Location.X + 100, buttonSud.Location.Y - 250);
            buttonVest.Location = new Point(buttonVest.Location.X + 250, buttonVest.Location.Y - 100);
            buttonEst.Location = new Point(buttonEst.Location.X - 180, buttonEst.Location.Y);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X - 100, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y - 100);
        ...
        public Serbia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Serbia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Belgrad__HOTEL_JUGOSLAVIJA;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Novi__Sad__HOTEL_PREZIDENT;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Novi_Pazar__HOTEL_VRBAK;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Pirot__HOTEL_ANA_LUX_SPA;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Užice__HOTEL_ZLATIBOR;
            }
            else
            {
                hotel = 1;
