...
{
    public partial class Norvegia : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X + 500, buttonNord.Location.Y - 50);
            buttonSud.Location = new Point(buttonSud.Location.X - 600, buttonSud.Location.Y);
        ...
        public Norvegia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Norvegia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bergen__HOTEL_CLARION_ADMIRAL;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 4)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bodø__HOTEL_THON_NORDLYS;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Oslo__HOTEL_CONTINENTAL;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tromsø__HOTEL_CLARION;
            }
            else
            {
                hotel = 1;
