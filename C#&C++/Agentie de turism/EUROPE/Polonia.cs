...
{
    public partial class Polonia : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonEst.Location = new Point(buttonEst.Location.X - 100, buttonEst.Location.Y);
        ...
        public Polonia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Polonia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Białystok__HOTEL_CRISTAL;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 14)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bydgoszcz__HOTEL_MARATON;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cracovia__HOTEL_POLONIA;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Gdańsk__HOTEL_FAHRENHEIT;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Gdynia__HOTEL_MERCURE;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Katowice__HOTEL_SILESIA;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Łódź__HOTEL_POLONIA_PALAST;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Lublin__HOTEL_B_B;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Poznań__HOTEL_POLONIA;
                                                else
                                                    if (hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Szczecin__HOTEL_RADISSON_BLU;
                                                    else
                                                        if (hotel == 11)
                                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Toruń__HOTEL_POLONIA;
                                                        else
                                                            if (hotel == 12)
                                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Varşovia__HOTEL_POLONIA_PALACE;
                                                            else
                                                                if(hotel == 13)
                                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Wroclaw__HOTEL_POLONIA;
                                                                else
                                                                    if(hotel == 14)
                                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Zamość__HOTEL_KORONNY;
