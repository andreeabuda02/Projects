...
namespace Agentie_de_turism
{
    public partial class Liechtenstein : Form
    {
        ...
        public Liechtenstein(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Liechtenstein_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Liechtenstein__HOTEL_TURNA_MALBUN;
        }
