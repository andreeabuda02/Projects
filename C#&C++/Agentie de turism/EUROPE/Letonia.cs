...
{
    public partial class Letonia : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonSud.Location = new Point(buttonSud.Location.X + 150, buttonSud.Location.Y - 150);
        ...
        public Letonia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Letonia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cēsis__HOTEL_CESIS;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Daugavpils__PARK_HOTEL_LATGOLA;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Liepāja__HOTEL_PROMENADE;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Rēzekne__HOTEL_KOLONNA_REZEKNE;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Riga__HOTEL_WELLTON_ELEFANT;
            }
            else
            {
                hotel = 1;
