...
{
    public partial class Lituania : Form
    {
        ...
        public Lituania(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Lituania_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kaunas__HOTEL_BOOK;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Klaipėda__HOTEL_AMBERTON_KLAIPEDA;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Šiauliai__HOTEL_ŠIAULIAI;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Trakay__HOTEL_TONYRESORT;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Vilnius__HOTEL_PANORAMA;
            }
            else
            {
                hotel = 1;
