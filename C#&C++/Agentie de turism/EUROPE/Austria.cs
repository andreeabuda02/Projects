...
namespace Agentie_de_turism
{
    public partial class Austria : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X + 400, buttonNord.Location.Y);
        ...
        public Austria(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Austria_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            panelHoteluri.Hide();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Graz__HOTEL_RAMADA_GRAZ;
            ascundeCasute();
            pozitieButoane();
            incarcareDate();
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Innsbruck__HOTEL_INNSBRUCK;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Linz__HOTEL_SCHILLERPARK;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Salzburg__HOTEL_AUSTRIA_TREND_SALZBURG_WEST;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Viena__HOTEL_AUSTRIA;
            }
            else
            {
                hotel = 1;
