...
{
    public partial class Ucraina : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonVest.Location = new Point(buttonVest.Location.X + 150, buttonVest.Location.Y - 100);
            buttonEst.Location = new Point(buttonEst.Location.X - 180, buttonEst.Location.Y);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X + 100, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y - 50);
        ...
        public Ucraina(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Ucraina_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cernăuţi__HOTEL_BUKOVINA;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 9)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Dnipropetrovsk__HOTEL_REICARTZ;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Harkov__HOTEL_OVIS;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Ivano_Frankivsk__HOTEL_NADIYA;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kiev__HOTEL_FAIRMONT_GRAND_HOTEL;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kryvyi_Rih__HOTEL_KRIVOY_ROG;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Odesa__HOTEL_NEMO;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Poltava__HOTEL_PREMIER_PALAZZO;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sevastopol__HOTEL_ADMIRAL;
            }
            else
            {
                hotel = 1;
