...
{
    public partial class Macedonia : Form
    {
        ...
        public Macedonia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Macedonia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bitola__HOTEL_KEOPS;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 7)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Ohrida__HOTEL_FILIP;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Prilep__HOTEL_ATLAS_CITY_CENTER;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Skopje__HOTEL_MARRIOTT;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Strumica__HOTEL_GLIGOROV;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tetovo__HOTEL_TIVOLI;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Veles__HOTEL_ROMANTIQUE_VELES;
            }
            else
            {
                hotel = 1;
