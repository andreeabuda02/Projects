...
namespace Agentie_de_turism
{
    public partial class Romania : Form
    {
        ...
        public Romania(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Romania_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Alba_Iulia__HOTEL_MARISS;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if( hotel <= 12)
            {
                if(hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Brașov__HOTEL_AMBIENT;
                    else
                        if(hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.București__HOTEL_ATHENEE_PALACE_HILTON;
                        else
                            if(hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cluj_Napoca__WEST_CITY_HOTEL;
                            else
                                if(hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Constanța__AQVATONIC_HOTEL___STEAUA_DE_MARE;
                                else
                                    if(hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Craiova__HOTEL_EMMA_WEST;
                                    else
                                        if(hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.HOTEL_TIMISOARA;
                                        else
                                            if(hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Iași__HOTEL_RAMADA;
                                            else
                                                if(hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Oradea__HOTEL_DUBLETREE;
                                                else
                                                    if(hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sibiu__HOTEL_HILTON;
                                                    else
                                                        if(hotel == 11)
                                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sighișoara__HOTEL_SIGHISOARA;
                                                        else
                                                            if(hotel == 12)
                                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Suceava__HOTEL_CONTINENTAL;
            }
            else
            {
                hotel = 1;
