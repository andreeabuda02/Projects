...
{
    public partial class Ungaria : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X + 200, buttonNord.Location.Y + 50);
            buttonSud.Location = new Point(buttonSud.Location.X - 300, buttonSud.Location.Y - 50);
            buttonVest.Location = new Point(buttonVest.Location.X + 50, buttonVest.Location.Y);
            buttonEst.Location = new Point(buttonEst.Location.X - 180, buttonEst.Location.Y);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X - 100, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y);
        ...
        public Ungaria(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Ungaria_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Budapesta__HOTEL_DANUBIUS;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 10)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Debrețin__HOTEL_MALOM;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Györ__HOTEL_IBIS;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kecskemét__BOUTIQUE_HOTEL_CENTER;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Miskolc__HOTEL_LIDO;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Pécs__HOTEL_AGOSTON;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Seghedin__HOTEL_AURIS;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Székesfehérvár__HOTEL_NOVOTEL;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Szombathely__HOTEL_PAZIO;
                                                else
                                                    if (hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Zalaegerszeg__HOTEL_ARANY_BARANY;
            }
            else
            {
                hotel = 1;
