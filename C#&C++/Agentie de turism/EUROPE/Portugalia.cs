...
namespace Agentie_de_turism
{
    public partial class Portugalia : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonSud.Location = new Point(buttonSud.Location.X, buttonSud.Location.Y);
            buttonVest.Location = new Point(buttonVest.Location.X + 150, buttonVest.Location.Y + 30);
            buttonEst.Location = new Point(buttonEst.Location.X - 300, buttonEst.Location.Y - 70);
        ...
        public Portugalia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Portugalia_Load(object sender, EventArgs e)
        {
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Algarve__HOTEL_ALGAVRE_CASINO;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 8)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Braga__HOTEL_DO_LAGO;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Elvas__HOTEL_VARCHOTEL;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Lisabona__HOTEL_AVENIDA_PALACE;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Porto__HOTEL_TRYP_PORTO_CENTRO;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sintra__HOTEL_LUXURY;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tavira__HOTEL_VILA_GALE;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Vila_Real__HOTEL_MIRA_CORGO;
            }
            else
            {
                hotel = 1;
