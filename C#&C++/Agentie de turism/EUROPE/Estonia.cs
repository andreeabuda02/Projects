...
namespace Agentie_de_turism
{
    public partial class Estonia : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X + 150, buttonNord.Location.Y );
            buttonSud.Location = new Point(buttonSud.Location.X + 150, buttonSud.Location.Y - 200);
            buttonVest.Location = new Point(buttonVest.Location.X + 150, buttonVest.Location.Y);
            buttonEst.Location = new Point(buttonEst.Location.X - 200, buttonEst.Location.Y - 50);
        ...
        public Estonia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Estonia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.HOTEL_GEORG_OTS_SPA;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 7)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Narva__HOTEL_NARVA;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Rakvere__AQVA_HOTEL;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sillamäe__HOTEL_KRUK;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tallinn__HOTEL_IMPERIAL;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tartu__HOTEL_DORPAT;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Võru__HOTEL_KUBIJA;
            }
            else
            {
                hotel = 1;
