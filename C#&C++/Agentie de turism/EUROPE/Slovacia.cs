...
{
    public partial class Slovacia : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonVest.Location = new Point(buttonVest.Location.X, buttonVest.Location.Y);
            buttonEst.Location = new Point(buttonEst.Location.X, buttonEst.Location.Y - 100);
        ...
        public Slovacia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Slovacia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Banská_Bystrica__HOTEL_LUX;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 9)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bardejov__HOTEL_LE_MONDE;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bratislava__HOTEL_BRATISLAVA;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Nitra__HOTEL_NITRA;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Piešťany__HOTEL_MAGNOLIA;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Rožňava__HOTEL_ARENA;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Spišská_Nová_Ves__HOTEL_METROPOL;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Trenčín__HOTEL_ELIZABETH;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Žilina___HOTEL_SLOVAKIA;
            }
            else
            {
                hotel = 1;
