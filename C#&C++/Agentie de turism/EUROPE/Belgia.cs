...
namespace Agentie_de_turism
{
    public partial class Belgia : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonSud.Location = new Point(buttonSud.Location.X, buttonSud.Location.Y - 200);
            buttonVest.Location = new Point(buttonVest.Location.X + 150, buttonVest.Location.Y - 200);
        ...
        public Belgia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Belgia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Anvers__HOTEL_ANTWERP_NATIONAL;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bruxelles__HOTEL_METROPOLE;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Dinant__HOTEL_MERVEILLEUSE_BY_INFINITI_RESORTS;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Gent__HOTEL_GRAVENSTEEN;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Liège__HOTEL_PREMIERE_CLASSE;
            }
            else
            {
                hotel = 1;
