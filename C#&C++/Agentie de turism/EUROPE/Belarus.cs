...
{
    public partial class Belarus : Form
    {
        ...
        public Belarus(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Belarus_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Brest__HOTEL_BELARUS;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Lida__HOTEL_EKVATOR ;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Mahilyow__HOTEL_ATRIUM;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Minsk__HOTEL_BELARUS;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Vitebsk__HOTEL_LUCHESA;
            }
            else
            {
                hotel = 1;
