...
{
    public partial class Grecia : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonSud.Location = new Point(buttonSud.Location.X - 300, buttonSud.Location.Y - 250);
            buttonVest.Location = new Point(buttonVest.Location.X + 100, buttonVest.Location.Y - 150);
            buttonEst.Location = new Point(buttonEst.Location.X - 850, buttonEst.Location.Y - 100);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X - 400, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y - 180);
        ...
        public Grecia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Grecia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Agios_Nikolaos__HOTEL_CORAL;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 7)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Atena__HOTEL_TITANIA;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Corfu__HOTEL_SUNSET;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Corint__HOTEL_MARION;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kavala__HOTEL_LUCY;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Patras__HOTEL_PORTO_RIO;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Salonic__HOTEL_ELECTRA_PALACE;
            }
            else
            {
                hotel = 1;
