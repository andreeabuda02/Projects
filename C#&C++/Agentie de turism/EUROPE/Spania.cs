...
{
    public partial class Spania : Form
    {
        ...
        public Spania(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        void pozitieButoane()
        {
            ...
            buttonSud.Location = new Point(buttonSud.Location.X - 100, buttonSud.Location.Y - 100);
            buttonVest.Location = new Point(buttonVest.Location.X + 250, buttonVest.Location.Y);
            buttonEst.Location = new Point(buttonEst.Location.X - 450, buttonEst.Location.Y);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X - 150, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y);
        ...
        private void Spania_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bilbao__HOTEL_OCCIDENTAL_BILBAO;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 12)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cordoba__HOTEL_CORDOBA_CENTER;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.HOTEL_W;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Madrid__HOTEL_EMPERADOR;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Mérida__HOTEL_TRYP_MEDEA;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Murcia__HOTEL_CELIA_MAR_MENOR_GOLF___SPA_RESORT;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.San_Sebastian_HOTEL_ARIMA;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sevilla__HOTEL_SILKEN_AL_ANDALUZ;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Toledo__HOTEL_BEATRIZ_TOLEDO_AUDITORIUM;
                                                else
                                                    if (hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Valencia__HOTEL_VALENCIA_CENTER;
                                                    else
                                                        if (hotel == 11)
                                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Vigo__HOTEL_ZENIT;
                                                        else
                                                            if (hotel == 12)
                                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Zaragoza__HOTEL_HIBERUS;
            }
            else
            {
                hotel = 1;
