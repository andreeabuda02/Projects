...
{
    public partial class Elvetia : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonEst.Location = new Point(buttonEst.Location.X - 180, buttonEst.Location.Y + 100);
        ...
        public Elvetia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Elvetia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Basel__HOTEL_IBIS_BUDGET;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 10)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Berna__HOTEL_KURSAAL;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Davos__HOTEL_CLUB_DAVOS;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Geneva__HOTEL_NOVOTEL_CENTRE;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Lausanne__HOTEL_DE_LA_PAIX_LAUSANNE;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Lucerna_HOTEL_RADISSON_BLU;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Lugano__HOTEL_SPLENDIDE_ROYAL;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sion__HOTEL_DES_VIGNES;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.St__Moritz__HOTEL_KULM;
                                                else
                                                    if (hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Zürich__HOTEL_BRISTOL;
            }
            else
            {
                hotel = 1;
