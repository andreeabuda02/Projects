...
{
    public partial class Albania : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonEst.Location = new Point(buttonEst.Location.X - 400, buttonEst.Location.Y);
        ...
        public Albania(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Albania_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Berat__HOTEL_COLOMBO;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 7)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Durrës__HOTEL_PALACE_SPA;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Pogradec__HOTEL_POGRADECI;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Saranda__HOTEL_SARANDA_PALACE;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Shkodër__HOTEL_COLOSSEO_SPA;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tirana__HOTEL_DINASTY;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Vlora__HOTEL_LIRO;
            }
            else
            {
                hotel = 1;
