...
{
    public partial class Olanda : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonVest.Location = new Point(buttonVest.Location.X + 330, buttonVest.Location.Y);
        ...
        public Olanda(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Olanda_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Amsterdam__HOTEL_FLETCHER;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 7)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Arnhem__HOTEL_HOLIDAY_INN;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Haga__HOTEL_NOVOTEL_THE_HAGUE_WORLD_FORUM;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Leeuwarden__HOTEL_ORANJE;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Maastricht__HOTEL_MONASTERE;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Rotterdam__HOTEL_ART;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Utrecht__HOTEL_MITLAND;
            }
            else
            {
                hotel = 1;
