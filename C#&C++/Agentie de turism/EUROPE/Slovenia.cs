...
{
    public partial class Slovenia : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X + 300, buttonNord.Location.Y + 100);
            buttonSud.Location = new Point(buttonSud.Location.X, buttonSud.Location.Y - 100);
            buttonVest.Location = new Point(buttonVest.Location.X + 250, buttonVest.Location.Y);
            buttonEst.Location = new Point(buttonEst.Location.X - 380, buttonEst.Location.Y);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X - 50, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y + 50);
        ...
        public Slovenia(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Slovenia_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bled_GRAND__HOTEL_TOPLICE;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 10)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Celje__HOTEL_CELIA;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Izola__HOTEL_MARINA;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kočevje__HOTEL_VALENTIN;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Koper__HOTEL_KOPER;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kranj__HOTEL_AZUL;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Ljubljana__M_HOTEL;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Maribor__HOTEL_MARIBOR;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Ptuj__GRAND_HOTEL_PRIMUS;
                                                else
                                                    if (hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Škofja_Loka__HOTEL_GARNI_PALETA;
            }
            else
            {
                hotel = 1;
