...
{
    public partial class Cipru : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X, buttonNord.Location.Y + 250);
        ...
        public Cipru(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Cipru_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Ayia_Napa__HOTEL_ASTERIAS_BEACH;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 4)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Kyrenia__HOTEL_OSCAR_SEAFRONT_HOTEL;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Limassol__HOTEL_ELIAS_BEACH;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Nicosia_Hotel_Crown;
            }
            else
            {
                hotel = 1;
