...
{
    public partial class Vatican : Form
    {
        ...
        public Vatican(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Vatican_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Vatican;
        }
