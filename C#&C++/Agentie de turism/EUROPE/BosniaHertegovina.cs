...
{
    public partial class BosniaHertegovina : Form
    {
        ...
        void pozitieButoane()
        {
            ...
            buttonSud.Location = new Point(buttonSud.Location.X + 200, buttonSud.Location.Y - 50);
            buttonVest.Location = new Point(buttonVest.Location.X + 400, buttonVest.Location.Y);
            buttonEst.Location = new Point(buttonEst.Location.X - 100, buttonEst.Location.Y - 50);
            buttonCentru.Location = new Point(pictureBoxfundal.Width / 2 - buttonCentru.Width / 2 + pictureBoxfundal.Location.X + 50, pictureBoxfundal.Height / 2 - buttonCentru.Height / 2 + pictureBoxfundal.Location.Y);
        ...
        public BosniaHertegovina(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void BosniaHertegovina_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Banja_Luka__HOTEL_CEZAR;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 11)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bihać__HOTEL_SAFIR;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Bijeljina__HOTEL_SICO;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Cazin__HOTEL_TAZZ;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Doboj__HOTEL_PARK;
                                else
                                    if (hotel == 6)
                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Goražde__HOTEL_BEHAR;
                                    else
                                        if (hotel == 7)
                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Mostar__HOTEL_EDEN;
                                        else
                                            if (hotel == 8)
                                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Neum___GRAND_HOTEL_NEUM;
                                            else
                                                if (hotel == 9)
                                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Sarajevo__HOTEL_EUROPE;
                                                else
                                                    if (hotel == 10)
                                                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Travnik__HOTEL_VEZIR_PALACE;
                                                    else
                                                        if (hotel == 11)
                                                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Zenica__HOTEL_ZENICA;
            }
            else
            {
                hotel = 1;
