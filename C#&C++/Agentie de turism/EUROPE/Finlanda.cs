...
{
    public partial class Finlanda : Form
    {
        ...
        void pozitieButoane()
        {
            buttonNord.Location = new Point(buttonNord.Location.X + 150, buttonNord.Location.Y - 50);
        ...
        public Finlanda(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Finlanda_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Helsinki__HOTEL_ARTHUR;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 5)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Oulu__HOTEL_RADISSON_BLU;
                    else
                        if (hotel == 3)
                            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Rovaniemi___HOTEL_ARCTIC_LIGHT;
                        else
                            if (hotel == 4)
                                panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Tampere__HOTEL_CUMULUS_TEMPERE;
                            else
                                if (hotel == 5)
                                    panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Turku__HOTEL_KUPITTA;
            }
            else
            {
                hotel = 1;
