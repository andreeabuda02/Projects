...
{
    public partial class Luxemburg : Form
    {
        ...
        public Luxemburg(string Cont, string Continent, string Tara)
        {
            InitializeComponent();
        ...
        private void Luxemburg_Load(object sender, EventArgs e)
        {
            cmd.Connection = con;
            ...
            pozitieButoane();
            incarcareDate();
            panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Diekirch__HOTEL_DU_PARC;
        }
        ...
        private void buttonHotelUrmator_Click(object sender, EventArgs e)
        {
            ...
            if (hotel <= 2)
            {
                if (hotel == 1)
                    ...
                    if (hotel == 2)
                        panelHoteluri.BackgroundImage = Agentie_de_turism.Properties.Resources.Luxemburg__HOTEL_EMPIRE;
            }
            else
            {
                hotel = 1;
